<x-guest-layout>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('jobs.update', $job->id) }}">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <x-text-input id="title" name='title' class="block mt-1 w-full" type="text" title="title"
                :value="old('title', $job->title)" required autofocus autocomplete="title" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="company" name='company' class="block mt-1 w-full" type="text" title="company"
                :value="old('company', $job->company)" required autocomplete="usertitle" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="location" name="location" class="block mt-1 w-full" type="text" title="location"
                required autocomplete="new-location" :value="old('location', $job->location)" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="website" name="website" class="block mt-1 w-full" type="url" title="website"
                required autocomplete="website" :value="old('website', $job->website)" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="tags" name="tags" class="block mt-1 w-full" type="text" title="tags" required
                autocomplete="tags" :value="old('tags', $job->tags)" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="experience" name="experience" class="block mt-1 w-full" type="number" title="experience"
                required autocomplete="experience" :value="old('experience', $job->experience)" />
        ...
        <div class="mt-4">
            ...
            @if (isset($job) && $job->logo)
                <img width="100" height="100" src="{{ asset('storage/' . $job->logo) }}">
            @endif

            <input
                class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                type="file" name="logo" id="logo" value={{ old('logo', $job->logo) }}>
